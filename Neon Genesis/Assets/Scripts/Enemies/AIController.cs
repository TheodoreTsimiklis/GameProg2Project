...
public class AIController : MonoBehaviour
{
    ...
    private void Chasing()
    {
        ...
        {
                if (m_WaitTime <= 0 && !m_CaughtPlayer && Vector3.Distance(transform.position, playerPrefab.transform.position) >= 6f)
            {
            ...
            {
                if (Vector3.Distance(transform.position, playerPrefab.transform.position) >= 2.5f)
